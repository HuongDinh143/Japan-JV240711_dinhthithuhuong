...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"ra.exam.controller", "ra.exam.service.imp", "ra.exam.repository.imp"})
...
public class AppConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/studentManagement?createDatabaseIfNotExist=true");
